...
-- Insert SHOWTIMES
-- =========================================
-- For movies 1,2,3 (Now Playing) we use a date in 2025.
-- You can adjust the times as desired.
...
-- Showtimes at Village Mall (theater 2) or Sobeys Square (theater 3)
INSERT INTO showtimes (id, movie_id, screen_id, start_time, end_time, date, price)
VALUES
...
-- Optionally add showtimes for the “Coming Soon” movies (id=4, id=5)
INSERT INTO showtimes (id, movie_id, screen_id, start_time, end_time, date, price)
VALUES
